...
# Build an image
# ./gcloud_build_image -s biblosphere-api-ihj6i2l2aq-uc.a.run.app -c 2020-04-09r0 -p biblosphere-210106

# Redeploy Docker
# gcloud run deploy biblosphere-api --image="gcr.io/biblosphere-210106/endpoints-runtime-serverless:biblosphere-api-ihj6i2l2aq-uc.a.run.app-2020-04-09r0" --allow-unauthenticated --platform managed --project=biblosphere-210106
...
# gcloud functions add-iam-policy-binding recognize_shelf --member "serviceAccount:779249096383-compute@developer.gserviceaccount.com" --role "roles/cloudfunctions.invoker" --project biblosphere-210106
